...
// ===== DATA =====
const PRODUCTS = [
  { id: 'lego-city', name: 'LEGO City Police Station', emoji: '&#129307;', category: 'lego', price: 349, originalPrice: 449, rating: 4.8, reviews: 234, tags: ['sale','popular'], description: 'תחנת משטרה אינטראקטיבית עם 743 חלקים, 3 כלי רכב ו-6 דמויות. מגיל 7+.' },
  { id: 'barbie-dream', name: 'ברבי Dreamtopia', emoji: '&#128131;', category: 'dolls', price: 129, originalPrice: 179, rating: 4.7, reviews: 187, tags: ['sale'], description: 'ברבי קסומה עם שיער ורוד, שמלת נסיכה ואביזרים. מגיל 3+.' },
  { id: 'rc-car', name: 'מכונית שלט 4×4 Off-Road', emoji: '&#128663;', category: 'rc', price: 249, originalPrice: null, rating: 4.6, reviews: 98, tags: ['new'], description: 'מכונית שלט חוצות עם גלגלים עצומים, 4 הנעות ומהירות 25 קמ"ש. מגיל 8+.' },
  { id: 'paint-kit', name: 'ערכת ציור מקצועית 120 צבעים', emoji: '&#127912;', category: 'arts', price: 189, originalPrice: 249, rating: 4.9, reviews: 312, tags: ['popular','sale'], description: 'ערכת ציור מקיפה עם עפרונות צבעוניים, מרקרים, צבעי מים וקנבס. מגיל 6+.' },
  { id: 'coding-robot-jr', name: 'רובוט קידוד לילדים', emoji: '&#129302;', category: 'educational', price: 299, originalPrice: 399, rating: 4.7, reviews: 145, tags: ['popular'], description: 'רובוט חכם שמלמד תכנות בצורה משחקית. תואם אפליקציית iOS/Android. מגיל 5+.' },
  { id: 'lego-technic', name: 'LEGO Technic Race Car', emoji: '&#127946;', category: 'lego', price: 499, originalPrice: 649, rating: 4.9, reviews: 89, tags: ['sale','popular'], description: 'מכונית מירוץ מפורטת עם מנוע פנימי פועל. 1,580 חלקים. מגיל 10+.' },
  { id: 'trampoline', name: 'טרמפולינה 3m עם רשת בטיחות', emoji: '&#127909;', category: 'outdoor', price: 899, originalPrice: 1199, rating: 4.5, reviews: 67, tags: ['sale'], description: 'טרמפולינה ביתית עם רשת בטיחות, 8 רגליים ומשטח קפיץ איכותי. מגיל 6+.' },
  { id: 'puzzle-1000', name: 'פאזל 1000 חלקים - ירושלים', emoji: '&#129513;', category: 'puzzles', price: 89, originalPrice: null, rating: 4.6, reviews: 203, tags: ['new'], description: 'פאזל פנורמי של ירושלים העתיקה, 1000 חלקים איכותיים. מגיל 12+.' },
  { id: 'baby-gym', name: 'שטיח פעילות לתינוק', emoji: '&#128118;', category: 'baby', price: 159, originalPrice: 199, rating: 4.8, reviews: 421, tags: ['popular'], description: 'שטיח פעילות מרופד עם 5 צעצועים תלויים, מוזיקה ואורות. 0-12 חודשים.' },
  { id: 'scooter-kids', name: 'קורקינט ילדים 3 גלגלים', emoji: '&#128692;', category: 'outdoor', price: 199, originalPrice: 269, rating: 4.7, reviews: 156, tags: ['sale','new'], description: 'קורקינט יציב ובטוח עם 3 גלגלים, גובה מתכוונן ובלם. מגיל 2+.' },
  { id: 'playdoh-mega', name: 'Play-Doh מגה סט 36 צבעים', emoji: '&#127774;', category: 'arts', price: 119, originalPrice: 149, rating: 4.6, reviews: 278, tags: ['popular'], description: '36 קופסאות פלאי-דו בצבעים שונים + 10 כלי יצירה. לא רעיל ובטוח לילדים. מגיל 2+.' },
  { id: 'monopoly-he', name: 'מונופול ישראל מהדורה חדשה', emoji: '&#127921;', category: 'puzzles', price: 149, originalPrice: null, rating: 4.5, reviews: 189, tags: ['new'], description: 'מונופול עם ערים ישראליות, שטרות מעוצבים ולוח מאויר יפה. מגיל 8+.' }
];
...
function loadMoreProducts() {
  const grid = document.getElementById('productsGrid');
  const more = [
    { id: 'extra1', name: 'חרב ומגן פיראט', emoji: '&#9876;&#65039;', category: 'dolls', price: 79, originalPrice: 99, rating: 4.3, reviews: 56, tags: ['sale'], description: 'סט תחפושת פיראטים כולל חרב, מגן וכובע.' },
    { id: 'extra2', name: 'אוהל משחק ילדים', emoji: '&#9978;&#65039;', category: 'outdoor', price: 149, originalPrice: null, rating: 4.5, reviews: 88, tags: ['new'], description: 'אוהל קמפינג לילדים לשימוש בחוץ ובבית.' },
